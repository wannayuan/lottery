        ...
        success: function (loginResult) {
            wx.getUserInfo({
                success: function (userResult) {
                    callback(null, {
                        code: loginResult.code,  //临时登录凭证
                        encryptedData: userResult.encryptedData, //加密数据
                        iv: userResult.iv, //加密算法的初始向量
                        userInfo: userResult.userInfo,  //用户信息
                    });
                },
...
setLoginUrl("https://nh20i6qu.qcloud.la/weapp/login");
module.exports = {
